...
# 📌 11주차 보고서
### 대학원 선배 멘토링 리뷰 보고서  
**Eureka Project · 소프트웨어융합대학 소프트웨어학과**  
팀: eureka-251-team-e25-sw01-03  
멘토링 키워드: #대학원진학 #연구실선택 #스타펠로우십 #AI도메인지식 #진로전략  
멘토링 주제: AI 분야 대학원 진학 및 커리어 로드맵 상담

---

## 1. 멘토링 개요
이번 멘토링에서는 AI 분야 대학원 진학 여부와 연구실 선택 전략, 지원 프로그램 활용, 마지막으로 커리어 로드맵에 대한 전반적인 대학원 준비 과정에 대해 알아볼 수 있는 기회였다. 멘토님의 실제 경험을 기반으로 이야기를 나눌 수 있었다. 특히 국민대학교 대학원 환경과 연구실 특징, 그리고 석·박사 과정에서 얻을 수 있는 경험과 지식에 대한 이야기를 추가적으로 나누었다.
...
### (1) 대학원 진학 고려 이유
**Q:** 대학원에 진학하는 이유는 무엇인가요?  
**A:** 대학원은 하고 싶은 연구를 더 깊게 해보고, 실무 경험을 쌓아 취업 경쟁력을 높이려는 목적으로 주로 진학한다. AI 분야는 석사 학위가 필요하거나 유리한 직무가 많아서 대학원 진학 비율이 높은 것 같다.

### (2) 국민대학교 대학원 선택 이유
**Q:** 국민대 대학원에 진학하는 이유는 무엇인가요?  
**A:** 국민대학교 대학원을 선택하는 이유로는 최근 국가와 기업에서 많은 지원을 받고 있어서 연구·개발에 몰두할 수 있기 때문이다. *스타 펠로우십* 같은 지원 프로그램이 대표적이다. 또한 연구실 교수님과의 사전 연락이 필요한데, 자대학원은 비교적 더 수월하다. 연구실별 실적과 분위기를 파악한 뒤 지원하는 절차는 꼭 필요하다.

### (3) 신생 랩실에 대한 우려
**Q:** 최근에 교수님들이 오셔서 신생 랩실이라고 알고 있습니다. 초기 세팅에 시간이 많이 들지 않나요?  
**A:** CS 랩실 특성상 초기 세팅에 큰 힘을 쏟지 않아도 되며, 대부분의 랩실이 이미 이를 마친 상태다. 교수님들의 연령대도 낮아 매우 열정적이다.

### (4) AI 연구 수행 시 어려움
**Q:** AI를 실제 연구에 적용하는 데 어려움이 있을 것 같은데, 어떤 점이 힘든가요?  
**A:** CS 지식이 있어 기본적인 부분은 문제가 없다. 다만 도메인 관련 전문 용어와 배경 지식을 이해하는 능력이 중요하다. 즉, 단순 AI 모델링이 아니라 **연구 주제의 도메인을 깊게 이해하는 역량**이 필요하다.

### (5) 대학원생의 일상 루틴
**Q:** 대학원생의 하루 루틴이 궁금합니다.  
**A:** 대학생과 비슷하게 수업을 듣고 과제를 하며, 가끔 교수님의 연구 및 행정 업무를 보조하기도 한다.

### (6) 대학원 준비 과정
**Q:** 대학원을 준비하는 과정에는 무엇이 있나요?  
**A:** 가장 중요한 것은 “무엇을 연구하고 싶은지”를 아는 것이다. 이를 위해 UROP처럼 소규모 연구 경험을 해보는 것이 도움이 된다. 캡스톤도 연구 기반 과제가 있으므로 적극 활용할 수 있다.

### (7) 대학원과 취업 관련 조언
멘토님 曰  
- 대학원을 목표로 한다면 **학점은 높게 유지**, 프로젝트 수는 많지 않아도 된다.  
- 취업(특히 개발 직군)을 목표로 한다면 **학점이 더 중요**하다.  
  - 일반 기업 기준: **3.3 이상**  
  - 대기업 목표: **3.8 이상 권장**

추가적으로, 최근 취업난을 고려하면 대학원에서 원하는 공부를 하며 **2년의 경력과 더불어 연구비·생활비 지원**을 받는 것도 좋은 선택이라고 조언했다.
...
1. **연구실 컨택은 필수**  
   - 연구 주제, 지도 스타일, 랩실 분위기 등을 반드시 확인해야 한다.
2. **흥미 기반 진학 중요**  
   - 흥미 없는 분야로 대학원 생활을 시작하면 지속하기 어렵다.
3. **국가·기업 지원 프로그램 확인 필요**  
   - 예: 스타 펠로우십
4. **1학년에게는 장기적 커리어 설계 강조**  
   - 학점·프로젝트 비율을 목표에 맞게 관리하면 큰 메리트가 있다.
5. **UROP 등 소규모 연구 경험 추천**  
   - 대학원 적성을 파악하는 데 효과적이다.

---

## 4. 전체 소감
이번 멘토링을 통해 AI 분야 대학원 진학에 필요한 실질적인 준비 과정에 대해 깊이 이해할 수 있었다. 팀원 중 일부는 대학원에 회의적인 시각을 가지고 있었고, 일부는 단순히 경력 쌓기 용도로 생각하기도 했다. 그러나 연구 분야를 깊게 공부하고, 연구기관 또는 기업의 연구 조직에서 실제 기여할 수 있다는 멘토님의 긍정적인 조언을 통해 대학원이라는 커리어 단계를 고려해 볼 수 있는 기회가 되었다.

또한 UROP 연구과제, Alpha Project, 캡스톤 산학협력 연구 등 학부생이 참여할 수 있는 다양한 프로그램을 추천받으며 실질적으로 대학원 경험을 미리 체감해볼 수 있는 방법도 확인할 수 있었다. 학점, 프로젝트, 연구 경험, 컨택 전략 등 장기적 커리어 설계에 필요한 구체적인 조언을 받은 유익한 시간이었다.
...
🔗20252311 김푸름  
> 이번 멘토링을 통해 AI 분야 대학원 진학 과정 전반을 보다 현실적으로 이해할 수 있었다. 단순히 진학 여부를 고민하는 수준을 넘어, 연구실 선택 기준과 장기적인 커리어 전략까지 명확하게 생각해볼 수 있는 계기가 되었다. 특히 학부 단계에서 활용 가능한 연구 경험  (UROP 등)의 중요성을 다시 한 번 확인할 수 있었다. 전반적으로 대학원 진학이 미래 선택지로서 충분히 가치 있다는 점을 깨닫게 해준 유익한 시간이었다.
...
면담 키워드: #미래기술 #대학진로 #적성 #추천시스템 #데이터베이스 #대학생활탐색

면담 주제 : 우리가 상상한 미래 포스터, 진로 및 대학 관련 상담 

---

## 1. 면담 개요
이번 면담에서는 우리 팀이 제작한 미래 기술 포스터에 대한 실현 가능성 평가와, 1학년 단계에서의 진로 탐색 방법, 향후 대학원·취업 방향성에 대한 조언을 들을 수 있었다. 교수님의 연구 분야인 추천 시스템과 데이터베이스 강의가 다루는 핵심 내용에 대해 설명해 주셨고, 실제 산업에서 데이터 처리 능력이 왜 중요한지 구체적으로 알려주셨다. 또한 추천 시스템의 결합, 멀티모달 데이터 활용 시 발생할 수 있는 문제 등 AI 기술의 확장 가능성과 한계도 함께 다루었다.

---

## 2. 면담 주요 내용

### (1) **Q** 저희 팀에서 만든 **미래 상상 포스터**에서 실현 가능하거나 어려울 것 같은 기술은 무엇일까요?

**A**  현재 로봇 기술이 많이 발전하고 있어 실현 가능성이 가장 높고, 그다음으로는 드론 배송 정도가 가능해 보인다. 그 외 기술들은 아직은 불확실하다. 드론 택시는 교통 혼잡을 줄일 수 있지만 비용과 안정성 문제가 남아 있다. 자율주행 자동차는 이미 5단계까지 개발 중이며, 먼 미래에는 상용화가 충분히 이뤄졌을 수 있다. 

### (2) **Q** 저학년 학생을 위해 대학원 진학과 취업의 **두 가지 방향에 대한 조언**을 부탁드립니다.

**A** 1학년이라면 우선 스스로를 알아가는 시기이기 때문에 자신의 적성과 방향성을 찾는 데 시간을 쓰면 좋을 것 같다. 학술과 관련이 없는 동아리라도 좋고, 학교 지원 프로그램들을 적극적으로 활용해 보는 것을 추천한다. 자신이 어떤 분야에 강점이 있고 어떤 도메인을 깊게 공부하고 싶은지 탐색하는 과정이 중요하다.

### (3) **Q** 교수님께서는 어떤 **분야**를 연구하고 계신지 궁금합니다.

**A** 데이터 마이닝 분야 중에서도 추천 시스템을 주로 연구한다. 추천 시스템이란 저장된 데이터를 바탕으로 사용자가 관심을 가질 만한 정보를 예측·제공하는 기술을 말하며, 대표적인 예시에는 유튜브 알고리즘이 있다.

### (4) **Q**  LLM이 사용자의 데이터를 **어떤 방식으로 기억하고 활용하나요**? 

**A** LLM뿐 아니라 대부분의 시스템은 데이터를 하드디스크나 SSD 같은 대용량 저장장치에 보관한다. 연산이 필요할 땐 메모리나 캐시에 불러와 처리한다. LLM도 외부 데이터를 모델을 통해 학습시켜 저장한 뒤 다시 활용할 수 있다.

### (5) **Q** 교수님의 **데이터베이스 강의**는 어떤 내용인지, 미리 예습할 부분에는 어떤 것이 있는지 궁금합니다.

**A** 데이터베이스 강의는 주로 데이터 설계와 관련된 내용이며, SQL을 사용해 특정 데이터를 어떻게 다루는지를 배운다. 
선행 지식은 크게 필요 없지만, 자료구조를 먼저 들으면 이해가 훨씬 쉽다.

### (6) **Q** **마케팅·홍보 미디어 분야**에서도 소프트웨어와 데이터가 중요해지고 있는데 조언 부탁드립니다. 

**A** 해당 분야는 매우 넓지만, 예를 들면 데이터 크롤링 같은 기법을 활용하기도 한다. 또한 광고 제작에서는 지역·나이 등 타깃 정보를 빠르게 불러오고 연산하는 것이 중요한데, 이는 모두 SQL 활용 능력과 관련된다. 때문에 SQL을 잘 익혀두면 확실히 큰 도움이 된다.

### (7) **Q** 최근 AI·IT 기술이 여러 도메인 간 융합되는 흐름인데, 교수님의 연구 분야가 **다른 도메인과 결합된다면**? 

**A**  아마 비전(Computer Vision) 분야와의 결합이 예상됨. 예를 들어 사용자의 행동 로그 분석, 멀티모달 모델링, 뉴스 기사 이미지 분석 등이 가능하다.

### (8) **Q**  멀티모달 데이터가 **부정적인 방향으로 학습될 가능성**은 없을까요? 

**A** 모델 설계가 적절하지 않거나 모델 규모가 너무 작을 경우 가능하다. 관련 없는 데이터가 섞이면 노이즈가 발생해 정확도가 떨어질 수 있다.

---
## 3. 요약 및 정리

1. **로봇·드론 기술 가능성**
   - 현재 기술 수준에서 가장 실현 가능성이 높으며, 드론 배송 등은 가까운 시기에 상용화될 수 있음.

2. **자율주행·미래 기술 한계**
   - 자율주행은 고도화 단계지만, 드론 택시는 비용·안정성 문제로 시간이 더 필요함.

3. **1학년 진로 탐색 조언**
   - 자기 이해와 다양한 활동 경험이 중요하며, 이를 통해 관심 도메인을 찾는 과정이 필요함.
  
4. **AI 융합 가능성**
   - 추천 시스템은 비전 기술과의 결합 가능성이 크며, 멀티모달 데이터는 노이즈 등 한계도 존재함.
     
---

## 4. 전체 소감
이번 면담을 통해 우리 팀이 상상한 미래 기술들이 실제로 어느 정도 가능성이 있는지 전문가의 시각에서 객관적으로 들을 수 있어 유익한 시간이었다. 특히 로봇·드론 기술처럼 이미 상용화 단계에 가까운 기술과, 비용·안전성 문제로 시간이 더 필요한 기술을 구분해 설명해 주신 점이 미래 기술을 바라보는 관점을 넓혀 주었다.

또한 1학년 시기에 자기 이해와 경험의 폭을 넓히는 것이 중요하다는 조언을 통해, 앞으로의 대학생활을 어떻게 설계해야 할지 다시 생각해보게 되었다. 추천 시스템 연구, SQL 활용, AI와 비전의 융합 가능성 등의 설명도 실제 전공 공부와 진로 선택에 직접적인 도움이 되었다. 전반적으로 미래 기술과 진로 탐색을 함께 돌아볼 수 있었던 의미 있는 면담이었다.
...
🔗20252302 김세인  
> 실제 세부적인 연구를 하고있는 교수님이 어떤 것을 하고, 또 그 분야에 대해 알아볼 수 있어서 유용했다. 또한 학교에서 어떤 활동을 하면 좋고 대학에서의 미래 진로(취업, 연구 등)를 어떻게 설정할지 조금이라도 더 탐색하는 기회가 되었다. 기술의 세부 연구 분야나 대학교 관련 정보는 친구들과 대화하거나 온라인에 검색하여 얻을 수 있는 데에는 한계가 있기 때문에 교수님과도 상담을 하여 새로운 정보도 얻을 수 있었던 것 같다.

🔗20252311 김푸름  
> 이번 면담을 통해 우리가 만든 미래 기술 포스터를 실제 연구자의 시각에서 검토받으며 현실적인 관점을 얻을 수 있었다. 로봇·드론처럼 가까운 기술과 아직 시간이 필요한 기술을 구분해주신 설명은 기술 이해도를 넓히는 데 도움이 되었다. 1학년 시기에는 다양한 경험을 통해 적성을 탐색해보라는 조언이 가장 마음에 남았다. 추천 시스템과 데이터베이스 강의에 대한 설명도 전공 공부의 방향을 잡는 데 실질적인 참고가 되었다. 전반적으로 미래 기술과 전공 학습을 함께 생각해볼 수 있었던 차분하고 유익한 시간이었다.
