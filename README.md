...
### (1)
**Q** 저희 팀에서 만든 **미래 상상 포스터**에서 실현 가능하거나 어려울 것 같은 기술은 무엇일까요?
...
### (2) 
**Q** 저학년 학생을 위해 대학원 진학과 취업의 **두 가지 방향에 대한 조언**을 부탁드립니다.
...
### (6)
**Q** **마케팅·홍보 미디어 분야**에서도 소프트웨어와 데이터가 중요해지고 있는데 조언이 있다면? 
...
### (7)
**Q** 최근 AI·IT 기술이 여러 도메인 간 융합되는 흐름인데, 교수님의 연구 분야가 **다른 도메인과 결합된다면**? 
**A**  아마 비전(Computer Vision) 분야와의 결합이 예상됨. 예를 들어 사용자의 행동 로그 분석, 멀티모달 모델링, 뉴스 기사 이미지 분석 등이 가능하다.

### (8)
**Q**  멀티모달 데이터가 **부정적인 방향으로 학습될 가능성**은 없을지? 
