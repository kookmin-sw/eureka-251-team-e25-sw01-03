...
🔗20252311 김푸름  
> 이번 멘토링을 통해 AI 분야 대학원 진학 과정 전반을 보다 현실적으로 이해할 수 있었다. 단순히 진학 여부를 고민하는 수준을 넘어, 연구실 선택 기준과 장기적인 커리어 전략까지 명확하게 생각해볼 수 있는 계기가 되었다. 특히 학부 단계에서 활용 가능한 연구 경험  (UROP, 산학 프로젝트 등)의 중요성을 다시 한 번 확인할 수 있었다. 전반적으로 대학원 진학이 미래 선택지로서 충분히 가치 있다는 점을 깨닫게 해준 유익한 시간이었다.
